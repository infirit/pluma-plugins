...
#
class PlumaLaTeXPlugin_MenuToolAction(gtk.Action):
	__gtype_name__ = "PlumaLaTeXPlugin_MenuToolAction"

gobject.type_register(PlumaLaTeXPlugin_MenuToolAction)
# needs PyGTK 2.10
PlumaLaTeXPlugin_MenuToolAction.set_tool_item_type(gtk.MenuToolButton)
...
class Action(object):
	...
	def hook(self, action_group, window_context):
		...
		if self.menu_tool_action:
			action_clazz = PlumaLaTeXPlugin_MenuToolAction
		else:
...
class WindowContext(object):
	...
	def __init__(self, window_decorator, editor_scope_view_classes):
		"""
		@param window_decorator: the PlumaWindowDecorator this context corresponds to
