...
This is DEPRECATED as xdvi may connect to pluma directly. The following command line was
used to connect xdvi with pluma:

xdvi -unique -s 6 -bg white -editor "dbus-send --type=method_call --dest=org.pluma.LaTeXPlugin /org/pluma/LaTeXPlugin/InverseSearchService org.pluma.LaTeXPlugin.InverseSearchService.inverse_search string:%f int32:%l" "$shortname.dvi"
"""
...
BUS_NAME = 'org.pluma.LaTeXPlugin'
OBJECT_PATH = '/org/pluma/LaTeXPlugin/InverseSearchService'
...
try:
	...
	class InverseSearchService(dbus.service.Object):
		...
		@dbus.service.method('org.pluma.LaTeXPlugin.InverseSearchService')
